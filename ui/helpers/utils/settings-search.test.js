...
const t = (key) => {
  switch (key) {
    ...
    case 'participateInDexMetrics':
      return 'Participate in DexMetrics';
    case 'participateInDexMetricsDescription':
      return 'Participate in DexMetrics to help us make DexWallet better';
    case 'alerts':
      return 'Alerts';
    ...
    case 'about':
      return 'About';
    case 'dexwalletVersion':
      return 'DexWallet Version';
    case 'builtAroundTheWorld':
      return 'DexWallet is designed and built around the world.';
    case 'links':
      return 'Links';
    case 'privacyMsg':
