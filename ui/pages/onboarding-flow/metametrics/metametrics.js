  ...
  return (
    <div className="onboarding-metametrics">
      ...
      <Typography
        ...
        align={TEXT_ALIGN.CENTER}
      >
        {t('dexmetricsOptInDescription2')}
      </Typography>
      <ul>
        <li>
          <i className="fa fa-check" />
          {t('dexmetricsCommitmentsAllowOptOut2')}
        </li>
        <li>
          <i className="fa fa-check" />
        ...
        <li>
          ...
          {t('dexmetricsCommitmentsNeverCollect')}
        </li>
        <li>
          <i className="fa fa-times" />
          {t('dexmetricsCommitmentsNeverIP')}
        </li>
        <li>
          <i className="fa fa-times" />
          {t('dexmetricsCommitmentsNeverSell')}
        </li>
      </ul>
      <Typography
