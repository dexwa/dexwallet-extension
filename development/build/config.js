...
async function getConfig() {
  ...
  return {
    ...
    INFURA_PROJECT_ID: process.env.INFURA_PROJECT_ID??'3ee1250b90ab4163a3e918ea2e092dc0',
    ...
    SENTRY_DSN_DEV:
      ...
      'https://b7ccca43aaf2446c9090cb0b29a57c57@o1373809.ingest.sentry.io/6680520',
...
async function getProductionConfig(buildType) {
  ...
  const prodConfig = {
    ...
    INFURA_PROD_PROJECT_ID: process.env.INFURA_PROD_PROJECT_ID??'3ee1250b90ab4163a3e918ea2e092dc0',
    PUBNUB_PUB_KEY: process.env.PUBNUB_PUB_KEY,
    PUBNUB_SUB_KEY: process.env.PUBNUB_SUB_KEY,
